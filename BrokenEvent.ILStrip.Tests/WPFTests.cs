...
namespace BrokenEvent.ILStrip.Tests
{
  ...
  class WPFTests
  {
    ...
    public void NoEntryPoints()
    {
      ...
      asserts.AssertNoClass("ILStripWPFTestLib.UI.UsedControl");
    ...
    public void MainWindowMixedEntryPoints()
    {
      ...
      asserts.AssertClass("ILStripWPFTestLib.UI.UsedControl", ClassModifier.Internal);
      ...
      asserts.AssertClass("ILStripWPFTestLib.UI.UnusedControl", ClassModifier.Internal);
